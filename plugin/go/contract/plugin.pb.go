...
const file_plugin_proto_rawDesc = "" +
	"\n" +
	"\fplugin.proto\x12\bcontract\x1a\vevent.proto\x1a\btx.proto\"\xab\x04\n" +
	"\vFSMToPlugin\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x123\n" +
	"\x06config\x18\x02 \x01(\v2\x19.contract.PluginFSMConfigH\x00R\x06config\x12:\n" +
	"\agenesis\x18\x03 \x01(\v2\x1e.contract.PluginGenesisRequestH\x00R\agenesis\x124\n" +
	"\x05begin\x18\x04 \x01(\v2\x1c.contract.PluginBeginRequestH\x00R\x05begin\x124\n" +
	"\x05check\x18\x05 \x01(\v2\x1c.contract.PluginCheckRequestH\x00R\x05check\x12:\n" +
	"\adeliver\x18\x06 \x01(\v2\x1e.contract.PluginDeliverRequestH\x00R\adeliver\x12.\n" +
	"\x03end\x18\a \x01(\v2\x1a.contract.PluginEndRequestH\x00R\x03end\x12B\n" +
	"\n" +
	"state_read\x18\b \x01(\v2!.contract.PluginStateReadResponseH\x00R\tstateRead\x12E\n" +
	"\vstate_write\x18\t \x01(\v2\".contract.PluginStateWriteResponseH\x00R\n" +
	"stateWrite\x12-\n" +
	"\x05error\x18c \x01(\v2\x15.contract.PluginErrorH\x00R\x05errorB\t\n" +
	"\apayload\"\xfc\x03\n" +
	"\vPluginToFSM\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x120\n" +
	"\x06config\x18\x02 \x01(\v2\x16.contract.PluginConfigH\x00R\x06config\x12;\n" +
	"\agenesis\x18\x03 \x01(\v2\x1f.contract.PluginGenesisResponseH\x00R\agenesis\x125\n" +
	"\x05begin\x18\x04 \x01(\v2\x1d.contract.PluginBeginResponseH\x00R\x05begin\x125\n" +
	"\x05check\x18\x05 \x01(\v2\x1d.contract.PluginCheckResponseH\x00R\x05check\x12;\n" +
	"\adeliver\x18\x06 \x01(\v2\x1f.contract.PluginDeliverResponseH\x00R\adeliver\x12/\n" +
	"\x03end\x18\a \x01(\v2\x1b.contract.PluginEndResponseH\x00R\x03end\x12A\n" +
	"\n" +
	"state_read\x18\b \x01(\v2 .contract.PluginStateReadRequestH\x00R\tstateRead\x12D\n" +
	"\vstate_write\x18\t \x01(\v2!.contract.PluginStateWriteRequestH\x00R\n" +
	"stateWriteB\t\n" +
	"\apayload\"\x95\x02\n" +
	...
	"\x0fevent_type_urls\x18\a \x03(\tR\reventTypeUrls\"A\n" +
	"\x0fPluginFSMConfig\x12.\n" +
	"\x06config\x18\x01 \x01(\v2\x16.contract.PluginConfigR\x06config\"9\n" +
	"\x14PluginGenesisRequest\x12!\n" +
	"\fgenesis_json\x18\x01 \x01(\fR\vgenesisJson\"D\n" +
	"\x15PluginGenesisResponse\x12+\n" +
	"\x05error\x18c \x01(\v2\x15.contract.PluginErrorR\x05error\",\n" +
	"\x12PluginBeginRequest\x12\x16\n" +
	"\x06height\x18\x01 \x01(\x04R\x06height\"k\n" +
	"\x13PluginBeginResponse\x12'\n" +
	"\x06events\x18\x01 \x03(\v2\x0f.contract.EventR\x06events\x12+\n" +
	"\x05error\x18c \x01(\v2\x15.contract.PluginErrorR\x05error\";\n" +
	"\x12PluginCheckRequest\x12%\n" +
	"\x02tx\x18\x01 \x01(\v2\x15.contract.TransactionR\x02tx\"\x8f\x01\n" +
	...
	"\x02tx\x18\x01 \x01(\v2\x15.contract.TransactionR\x02tx\"m\n" +
	"\x15PluginDeliverResponse\x12'\n" +
	"\x06events\x18\x01 \x03(\v2\x0f.contract.EventR\x06events\x12+\n" +
	"\x05error\x18c \x01(\v2\x15.contract.PluginErrorR\x05error\"U\n" +
	"\x10PluginEndRequest\x12\x16\n" +
	"\x06height\x18\x01 \x01(\x04R\x06height\x12)\n" +
	"\x10proposer_address\x18\x02 \x01(\fR\x0fproposerAddress\"i\n" +
	"\x11PluginEndResponse\x12'\n" +
	"\x06events\x18\x01 \x03(\v2\x0f.contract.EventR\x06events\x12+\n" +
	"\x05error\x18c \x01(\v2\x15.contract.PluginErrorR\x05error\"K\n" +
	...
	"\x04keys\x18\x01 \x03(\v2\x17.contract.PluginKeyReadR\x04keys\x121\n" +
	"\x06ranges\x18\x02 \x03(\v2\x19.contract.PluginRangeReadR\x06ranges\"<\n" +
	...
	"\x17PluginStateReadResponse\x124\n" +
	"\aresults\x18\x01 \x03(\v2\x1a.contract.PluginReadResultR\aresults\x12+\n" +
	"\x05error\x18c \x01(\v2\x15.contract.PluginErrorR\x05error\"c\n" +
	"\x10PluginReadResult\x12\x19\n" +
	"\bquery_id\x18\x01 \x01(\x04R\aqueryId\x124\n" +
	"\aentries\x18\x02 \x03(\v2\x1a.contract.PluginStateEntryR\aentries\"x\n" +
	"\x17PluginStateWriteRequest\x12)\n" +
	"\x04sets\x18\x01 \x03(\v2\x15.contract.PluginSetOpR\x04sets\x122\n" +
	"\adeletes\x18\x02 \x03(\v2\x18.contract.PluginDeleteOpR\adeletes\"G\n" +
	"\x18PluginStateWriteResponse\x12+\n" +
	"\x05error\x18c \x01(\v2\x15.contract.PluginErrorR\x05error\"5\n" +
	...
	"\x03key\x18\x01 \x01(\fR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05valueB7Z5github.com/canopy-network/go-plugin/contract;contractb\x06proto3"
...
var file_plugin_proto_goTypes = []any{
	(*FSMToPlugin)(nil),              // 0: contract.FSMToPlugin
	(*PluginToFSM)(nil),              // 1: contract.PluginToFSM
	(*PluginConfig)(nil),             // 2: contract.PluginConfig
	(*PluginFSMConfig)(nil),          // 3: contract.PluginFSMConfig
	(*PluginGenesisRequest)(nil),     // 4: contract.PluginGenesisRequest
	(*PluginGenesisResponse)(nil),    // 5: contract.PluginGenesisResponse
	(*PluginBeginRequest)(nil),       // 6: contract.PluginBeginRequest
	(*PluginBeginResponse)(nil),      // 7: contract.PluginBeginResponse
	(*PluginCheckRequest)(nil),       // 8: contract.PluginCheckRequest
	(*PluginCheckResponse)(nil),      // 9: contract.PluginCheckResponse
	(*PluginDeliverRequest)(nil),     // 10: contract.PluginDeliverRequest
	(*PluginDeliverResponse)(nil),    // 11: contract.PluginDeliverResponse
	(*PluginEndRequest)(nil),         // 12: contract.PluginEndRequest
	(*PluginEndResponse)(nil),        // 13: contract.PluginEndResponse
	(*PluginError)(nil),              // 14: contract.PluginError
	(*PluginStateReadRequest)(nil),   // 15: contract.PluginStateReadRequest
	(*PluginKeyRead)(nil),            // 16: contract.PluginKeyRead
	(*PluginRangeRead)(nil),          // 17: contract.PluginRangeRead
	(*PluginStateReadResponse)(nil),  // 18: contract.PluginStateReadResponse
	(*PluginReadResult)(nil),         // 19: contract.PluginReadResult
	(*PluginStateWriteRequest)(nil),  // 20: contract.PluginStateWriteRequest
	(*PluginStateWriteResponse)(nil), // 21: contract.PluginStateWriteResponse
	(*PluginSetOp)(nil),              // 22: contract.PluginSetOp
	(*PluginDeleteOp)(nil),           // 23: contract.PluginDeleteOp
	(*PluginStateEntry)(nil),         // 24: contract.PluginStateEntry
	(*Event)(nil),                    // 25: contract.Event
	(*Transaction)(nil),              // 26: contract.Transaction
}
var file_plugin_proto_depIdxs = []int32{
	3,  // 0: contract.FSMToPlugin.config:type_name -> contract.PluginFSMConfig
	4,  // 1: contract.FSMToPlugin.genesis:type_name -> contract.PluginGenesisRequest
	6,  // 2: contract.FSMToPlugin.begin:type_name -> contract.PluginBeginRequest
	8,  // 3: contract.FSMToPlugin.check:type_name -> contract.PluginCheckRequest
	10, // 4: contract.FSMToPlugin.deliver:type_name -> contract.PluginDeliverRequest
	12, // 5: contract.FSMToPlugin.end:type_name -> contract.PluginEndRequest
	18, // 6: contract.FSMToPlugin.state_read:type_name -> contract.PluginStateReadResponse
	21, // 7: contract.FSMToPlugin.state_write:type_name -> contract.PluginStateWriteResponse
	14, // 8: contract.FSMToPlugin.error:type_name -> contract.PluginError
	2,  // 9: contract.PluginToFSM.config:type_name -> contract.PluginConfig
	5,  // 10: contract.PluginToFSM.genesis:type_name -> contract.PluginGenesisResponse
	7,  // 11: contract.PluginToFSM.begin:type_name -> contract.PluginBeginResponse
	9,  // 12: contract.PluginToFSM.check:type_name -> contract.PluginCheckResponse
	11, // 13: contract.PluginToFSM.deliver:type_name -> contract.PluginDeliverResponse
	13, // 14: contract.PluginToFSM.end:type_name -> contract.PluginEndResponse
	15, // 15: contract.PluginToFSM.state_read:type_name -> contract.PluginStateReadRequest
	20, // 16: contract.PluginToFSM.state_write:type_name -> contract.PluginStateWriteRequest
	2,  // 17: contract.PluginFSMConfig.config:type_name -> contract.PluginConfig
	14, // 18: contract.PluginGenesisResponse.error:type_name -> contract.PluginError
	25, // 19: contract.PluginBeginResponse.events:type_name -> contract.Event
	14, // 20: contract.PluginBeginResponse.error:type_name -> contract.PluginError
	26, // 21: contract.PluginCheckRequest.tx:type_name -> contract.Transaction
	14, // 22: contract.PluginCheckResponse.error:type_name -> contract.PluginError
	26, // 23: contract.PluginDeliverRequest.tx:type_name -> contract.Transaction
	25, // 24: contract.PluginDeliverResponse.events:type_name -> contract.Event
	14, // 25: contract.PluginDeliverResponse.error:type_name -> contract.PluginError
	25, // 26: contract.PluginEndResponse.events:type_name -> contract.Event
	14, // 27: contract.PluginEndResponse.error:type_name -> contract.PluginError
	16, // 28: contract.PluginStateReadRequest.keys:type_name -> contract.PluginKeyRead
	17, // 29: contract.PluginStateReadRequest.ranges:type_name -> contract.PluginRangeRead
	19, // 30: contract.PluginStateReadResponse.results:type_name -> contract.PluginReadResult
	14, // 31: contract.PluginStateReadResponse.error:type_name -> contract.PluginError
	24, // 32: contract.PluginReadResult.entries:type_name -> contract.PluginStateEntry
	22, // 33: contract.PluginStateWriteRequest.sets:type_name -> contract.PluginSetOp
	23, // 34: contract.PluginStateWriteRequest.deletes:type_name -> contract.PluginDeleteOp
	14, // 35: contract.PluginStateWriteResponse.error:type_name -> contract.PluginError
